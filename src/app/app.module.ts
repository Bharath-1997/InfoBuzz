...
import { MainComponent } from './basechat/main/main.component';
import { UserListComponent } from './basechat/user-list/user-list.component';
import { FeedComponent } from './basechat/feed/feed.component';
import { ChatFormComponent } from './basechat/chat-form/chat-form.component';
import { MessageComponent } from './basechat/message/message.component';
import { AngularFireDatabase } from '@angular/fire/database';
import { UserItemComponent } from './basechat/user-item/user-item.component';
...
@NgModule({
  ...
  providers: [EmployeeService,AuthService,AuthGuard,IsloggedinauthGuard,ChatService,AngularFireDatabase],
