...
export class AuthService {
  ...
  constructor(public afAuth:AngularFireAuth,public router:Router,private toaster:ToastrService,private firestore:AngularFirestore,private service:EmployeeService) 
  {
  ...
  login(email:string,password:string)
  {
    ...
    this.afAuth.auth.signInWithEmailAndPassword(email,password).then(
       value => {
        ...
        this.service.updatestatus("online");
  ...
  Logout()
  {
    this.service.updatestatus("offline");
